...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="portlet-body">
                                <div class="table-scrollable table-scrollable-borderless">
                                    ...
                                    <dx:ASPxPopupControl ID="pcTurno" runat="server" CloseAction="OuterMouseClick" CloseOnEscape="true"
                                        ...
                                        HeaderText="Turno" AllowDragging="True" Modal="True" PopupAnimationType="Fade" Width="800"
                                                                ...
                                                                <div class="container-fluid">
                                                                    <div class="row margin-top-10">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="profile-sidebar" id="userProfile" runat="server" style="width: 150px;">
                                                                                <!-- PORTLET MAIN -->
                                                                            ...
                                                                            <div class="profile-content">
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="portlet light">
                                                                                            <div class="portlet-title tabbable-line" id="divValoracionTurno" runat="server">
                                                                                                <div class="caption caption-md">
                                                                                                    <i class="icon-globe theme-font hide"></i>
                                                                                                    <span class="caption-subject font-blue-madison bold uppercase">Info del Turno</span>
                                                                                                </div>
                                                                                                <%--<ul class="nav nav-tabs">
                                                                                                    <li class="active">
                                                                                                        <a onclick="showPopUpValoracionUsuario()">Valoración del Usuario</a>
                                                                                                    </li>
                                                                                                </ul>--%>
                                                                                            </div>
                                                                                            <div class="portlet-body">
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-6">
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <asp:TextBox type="text" placeholder="Nombre" class="form-control" ID="txtNombreUsuario" runat="server"></asp:TextBox>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="col-md-6">
                                                                                                                    <div class="form-group">
                                                                                                                        <label class="control-label"><strong>Apellido: </strong></label>
                                                                                                                        <asp:TextBox type="text" placeholder="Apellido" class="form-control" ID="txtApellidoUsuario" runat="server"></asp:TextBox>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-6">
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <asp:TextBox type="text" placeholder="Telefono" class="form-control" ID="txtTelefono" runat="server"></asp:TextBox>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="col-md-6">
                                                                                                                    <div class="form-group">
                                    ...
                                    <!--BEGIN POPUP-->
                                    <dx:ASPxPopupControl ID="pcValoracionUsuario" runat="server" CloseAction="OuterMouseClick" CloseOnEscape="true"
                                        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ClientInstanceName="pcValoracionUsuario"
                                        HeaderText="Valoracion del Usuario" AllowDragging="True" Modal="True" PopupAnimationType="Fade" Width="600"
                                        EnableViewState="False" Theme="Metropolis">
                                        <ContentCollection>
    ...
    <script type="text/javascript">
        function showPopUpValoracionUsuario() {
            pcValoracionUsuario.Show();
        }
    </script>
</asp:Content>

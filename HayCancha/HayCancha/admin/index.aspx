<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="HayCancha.admin.index" %>
        ...
        <div class="page-head">
            <div class="container-fluid">
                ...
                <div class="page-title">
                    <h1>Dashboard <small>página de inicio</small></h1>
                </div>
                <!-- END PAGE TITLE -->
            </div>
        </div>
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                        ...
                                        <label class="btn btn-transparent grey-salsa btn-circle btn-sm">
                                            <input type="radio" name="options" class="toggle" id="Radio1">Month</label>
                                    </div>
                                </div>
                            </div>
